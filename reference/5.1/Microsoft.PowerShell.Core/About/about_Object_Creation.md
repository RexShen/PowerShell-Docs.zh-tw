...
- [Convertfrom-string-String](xref:Microsoft.PowerShell.Utility.ConvertFrom-String)：建置於 [FlashExtract](https://www.microsoft.com/research/publication/flashextract-framework-data-extraction-examples)上，會 `ConvertFrom-String` 從結構化字串資料建立自訂物件。
  本主題將示範並討論每一種方法。
