...
本主題說明如何在本機電腦上的 PowerShell 中執行背景工作。 如需在遠端電腦上執行背景工作的詳細資訊，請參閱 [about_Remote_Jobs](about_Remote_Jobs.md)。 如需執行緒作業的詳細資訊，請參閱 [about_Thread_Jobs](/powershell/module/microsoft.powershell.core/about/about_Thread_Jobs)。
