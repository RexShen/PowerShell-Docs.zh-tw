...
|目前的使用者，所有主機   |$Home \\ [My] Documents \\ WindowsPowerShell \\Profile.ps1 |
|目前的使用者，目前的主機|$Home \\ [My] Documents \\ WindowsPowerShell\\<br>Microsoft.PowerShell_profile.ps1 |
...
此外，裝載 PowerShell 的其他程式也可以支援自己的設定檔。 例如，PowerShell 整合式腳本環境 (ISE) 支援下列主機特定的設定檔。

|Description               | 路徑                                       |
|--------------------------|--------------------------------------------|
|所有使用者、目前的主機   |$PSHOME \\Microsoft.PowerShellISE_profile.ps1|
|目前的使用者，目前的主機|$Home \\ [My] Documents \\ WindowsPowerShell\\<br>Microsoft.PowerShellISE_profile.ps1 |
