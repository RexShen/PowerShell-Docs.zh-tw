...
本主題是 [about_Jobs](about_Jobs.md)、 [about_Thread_Jobs](/powershell/module/microsoft.powershell.core/about/about_Thread_Jobs)和 [about_Remote_Jobs](about_Remote_Jobs.md) 主題的補充。
