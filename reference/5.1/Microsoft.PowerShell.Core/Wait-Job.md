...
## 概要
抑制命令提示字元，直到會話中正在執行的其中一個或所有 Windows PowerShell 背景工作完成為止。
...
## DESCRIPTION
**等候工作** Cmdlet 會等候 Windows PowerShell 背景工作完成後，才會顯示命令提示字元。
...
如需有關 **Using** 範圍修飾符的詳細資訊，請參閱 about_Remote_Variables (https://go.microsoft.com/fwlink/?LinkID=252653) 。
