...
- 指令碼： 目前工作階段中的指令碼區塊。
- 流程。 PowerShell 工作流程。 如需詳細資訊，請參閱 [about_Workflows](../PSWorkflow/About/about_Workflows.md)。
...
如需詳細資訊，請參閱 `Import-Module` 和 [about_PSSnapins](../Microsoft.PowerShell.Core/About/about_PSSnapins.md)。
