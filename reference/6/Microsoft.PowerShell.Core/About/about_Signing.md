...
若要建立自我簽署憑證，請使用 `New-SelfSignedCertificate` PKI 模組中的 Cmdlet。 此模組是在 PowerShell 3.0 中引進，且包含在 Windows 8 和 Windows Server 2012 中。 如需詳細資訊，請參閱 Cmdlet 的說明主題 `New-SelfSignedCertificate` 。
