...
### <a name="does-powershell-support-remoting-over-ssh"></a>PowerShell 是否支援透過 SSH 進行遠端處理？

是。 如需詳細資訊，請參閱透過 [SSH 的 PowerShell 遠端](/powershell/scripting/learn/remoting/ssh-remoting-in-powershell-core)功能。
