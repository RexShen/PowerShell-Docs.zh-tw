...
本章節包含與 PowerShell Microsoft. PowerShell. 管理模組一起安裝之 Cmdlet 的說明主題。 管理模組包含可協助您在 PowerShell 中管理 Windows 的 Cmdlet。
...
取得剪貼簿的內容。  [!NOTE] > 在 Linux 上，此 Cmdlet 需要 `xclip` 公用程式位於路徑中。
