...
從 PowerShell 7.0 開始，可 `Invoke-WebRequest` 支援環境變數所定義的 proxy 設定。 請參閱本文的「 [附注](#notes) 」一節。
...
如需詳細資訊，請參閱 [BasicHtmlWebResponseObject](/dotnet/api/microsoft.powershell.commands.basichtmlwebresponseobject)。
