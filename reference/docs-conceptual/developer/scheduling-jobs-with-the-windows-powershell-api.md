...
## <a name="registering-the-job-with-the-task-scheduler"></a><span data-ttu-id="7a6e8-130">使用工作排程器註冊作業</span><span class="sxs-lookup"><span data-stu-id="7a6e8-130">Registering the Job with the Task Scheduler</span></span>
