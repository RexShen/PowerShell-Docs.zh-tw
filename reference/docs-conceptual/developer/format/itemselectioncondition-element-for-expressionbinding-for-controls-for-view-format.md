...
|元素|描述|
|-------------|-----------------|
|[View 之控制項的 ItemSelectionCondition 的 PropertyName 元素（格式）](./propertyname-element-for-itemselectioncondition-for-controls-for-view-format.md)|選擇性元素。<br /><br /> 指定觸發條件的 .NET 屬性。|
|[View 之控制項的 ItemSelectionCondition 的 ScriptBlock 元素（格式）](./scriptblock-element-for-itemselectioncondition-for-controls-for-view-format.md)|選擇性元素。<br /><br /> 指定觸發條件的腳本。|
