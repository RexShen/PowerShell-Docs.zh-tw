# <a name="powershell-core-support-lifecycle"></a><span data-ttu-id="dfc1c-101">PowerShell Core 支援週期</span><span class="sxs-lookup"><span data-stu-id="dfc1c-101">PowerShell Core Support Lifecycle</span></span>
