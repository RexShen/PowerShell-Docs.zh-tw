...
PowerShell 7 是針對雲端、內部部署和混合式環境所設計，具有增強功能和[新功能](What-s-New-in-PowerShell-70.md)。
...
PowerShell 7 與 Windows PowerShell 並存運作，可讓您在部署之前，輕鬆地在版本之間進行測試和比較。 移轉既簡單又快速，而且很安全。 失敗。
