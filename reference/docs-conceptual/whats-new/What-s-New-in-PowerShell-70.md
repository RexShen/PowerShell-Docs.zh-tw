...
## <a name="where-can-i-install-powershell"></a><span data-ttu-id="0c9c4-116">我可以在哪裡安裝 PowerShell？</span><span class="sxs-lookup"><span data-stu-id="0c9c4-116">Where can I install PowerShell?</span></span>
...
<span data-ttu-id="0c9c4-156">**Parallel** 參數會針對每個輸入記錄名稱指定平行執行的指令碼區塊。</span><span class="sxs-lookup"><span data-stu-id="0c9c4-156">The **Parallel** parameter specifies the script block that is run in parallel for each input log name.</span></span>
...
<span data-ttu-id="0c9c4-171">如需詳細資訊，請參閱[關於 If](/powershell/module/microsoft.powershell.core/about/about_if?view=powershell-7)。</span><span class="sxs-lookup"><span data-stu-id="0c9c4-171">For more information [About If](/powershell/module/microsoft.powershell.core/about/about_if?view=powershell-7).</span></span>
...
### <a name="null-conditional-assignment-operator-"></a><span data-ttu-id="0c9c4-191">Null 條件式指派運算子 ??=</span><span class="sxs-lookup"><span data-stu-id="0c9c4-191">Null conditional assignment operator ??=</span></span>
...
<span data-ttu-id="0c9c4-202">在下列範例中，會傳回成員屬性 **Status** 的值：</span><span class="sxs-lookup"><span data-stu-id="0c9c4-202">In the following example, the value of the member property **Status** is returned:</span></span>
...
- <span data-ttu-id="0c9c4-270">更新設定 PSModulePath 以串連處理序和電腦環境變數 (#11276)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-270">Update setting PSModulePath to concatenate the process and machine environment variables (#11276)</span></span>
...
- <span data-ttu-id="0c9c4-292">將 OutputType 新增至 Get-Error Cmdlet，並保留原始類型名稱 (#10856)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-292">Add OutputType to Get-Error cmdlet and preserve original typenames (#10856)</span></span>
...
- <span data-ttu-id="0c9c4-314">修正含有空格的 Start-Job -WorkingDirectory (#10951)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-314">Fix Start-Job -WorkingDirectory with whitespace (#10951)</span></span>
...
- <span data-ttu-id="0c9c4-336">修正設定 -TotalCount 時 Get-Content -ReadCount 0 的行為 (#10749) (感謝 @eugenesmlv！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-336">Fix Get-Content -ReadCount 0 behavior when -TotalCount is set (#10749) (Thanks @eugenesmlv!)</span></span>
...
- <span data-ttu-id="0c9c4-357">新增 PowerShell Core 群組原則定義 (#10468)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-357">Add PowerShell Core group policy definitions (#10468)</span></span>
...
### <a name="code-cleanup"></a><span data-ttu-id="0c9c4-376">程式碼清除</span><span class="sxs-lookup"><span data-stu-id="0c9c4-376">Code Cleanup</span></span>
...
- <span data-ttu-id="0c9c4-397">將 ActionPreference.Suspend 列舉值轉換為不支援的保留狀態，並在喜好設定變數中移除使用 ActionPreference.Ignore 的限制 (#10317) (感謝 @KirkMunro！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-397">Convert ActionPreference.Suspend enumeration value into a non-supported, reserved state, and remove restriction on using ActionPreference.Ignore in preference variables (#10317) (Thanks @KirkMunro!)</span></span>
- <span data-ttu-id="0c9c4-398">使用 List<T> 取代 ArrayList，以取得更容易閱讀且可靠的程式碼，而不需變更功能 (#10333) (感謝 @iSazonov！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-398">Replace ArrayList with List<T> to get more readable and reliable code without changing functionality (#10333) (Thanks @iSazonov!)</span></span>
- <span data-ttu-id="0c9c4-399">對 TestConnectionCommand 進行程式碼樣式修正 (#10439) (感謝 @vexx32！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-399">Make code style fixes to TestConnectionCommand (#10439) (Thanks @vexx32!)</span></span>
- <span data-ttu-id="0c9c4-400">清除 AutomationEngine，並移除額外的 SetSessionStateDrive 方法呼叫 (#10416) (感謝 @iSazonov！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-400">Cleanup AutomationEngine and remove extra SetSessionStateDrive method call (#10416) (Thanks @iSazonov!)</span></span>
- <span data-ttu-id="0c9c4-401">針對 ConvertTo-Csv 和 ConvertFrom-Csv，將預設的 ParameterSetName 再次重新命名為 Delimiter (#10425)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-401">Rename default ParameterSetName back to Delimiter for ConvertTo-Csv and ConvertFrom-Csv (#10425)</span></span>

### <a name="tools"></a><span data-ttu-id="0c9c4-402">工具</span><span class="sxs-lookup"><span data-stu-id="0c9c4-402">Tools</span></span>

- <span data-ttu-id="0c9c4-403">新增 SDKToUse 屬性的預設設定，使其建置於 VS 中 (#11085)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-403">Add default setting for the SDKToUse property so that it builds in VS (#11085)</span></span>
- <span data-ttu-id="0c9c4-404">Install-Powershell.ps1：新增參數以使用 MSI 安裝 (#10921) (感謝 @MJECloud！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-404">Install-Powershell.ps1: Add parameter to use MSI installation (#10921) (Thanks @MJECloud!)</span></span>
- <span data-ttu-id="0c9c4-405">新增 install-powershell.ps1 的基本範例 (#10914) (感謝 @kilasuit！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-405">Add basic examples for install-powershell.ps1 (#10914) (Thanks @kilasuit!)</span></span>
- <span data-ttu-id="0c9c4-406">讓 Install-PowerShellRemoting.ps1 處理 PowerShellHome 參數中的空字串 (#10526) (感謝 @Orca88！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-406">Make Install-PowerShellRemoting.ps1 handle empty string in PowerShellHome parameter (#10526) (Thanks @Orca88!)</span></span>
- <span data-ttu-id="0c9c4-407">在 install-powershell.sh 中，從 /etc/lsb-release 切換到 /etc/os-release (#10773) (感謝 @Himura2la！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-407">Switch from /etc/lsb-release to /etc/os-release in install-powershell.sh (#10773) (Thanks @Himura2la!)</span></span>
- <span data-ttu-id="0c9c4-408">在 Windows 上的每日版本中檢查 pwsh.exe 和 pwsh (#10738) (感謝 @centreboard！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-408">Check pwsh.exe and pwsh in daily version on Windows (#10738) (Thanks @centreboard!)</span></span>
- <span data-ttu-id="0c9c4-409">移除 installpsh-osx.sh 中不必要的點選 (#10752)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-409">Remove unneeded tap in installpsh-osx.sh (#10752)</span></span>
- <span data-ttu-id="0c9c4-410">更新 install-powershell.ps1，以檢查已經安裝的每日組建 (#10489)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-410">Update install-powershell.ps1 to check for already installed daily build (#10489)</span></span>

### <a name="tests"></a><span data-ttu-id="0c9c4-411">測試</span><span class="sxs-lookup"><span data-stu-id="0c9c4-411">Tests</span></span>

- <span data-ttu-id="0c9c4-412">讓不可靠的 DSC 測試暫止 (#11131)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-412">Make unreliable DSC test pending (#11131)</span></span>
- <span data-ttu-id="0c9c4-413">修正字串資料測試，以正確驗證雜湊表的索引鍵 (#10810)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-413">Fix stringdata test to correctly validate keys of hashtables (#10810)</span></span>
- <span data-ttu-id="0c9c4-414">卸載測試模組 (#11061) (感謝 @iSazonov！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-414">Unload test modules (#11061) (Thanks @iSazonov!)</span></span>
- <span data-ttu-id="0c9c4-415">增加測試 URL 的重試間隔時間 (#11015)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-415">Increase time between retries of testing URL (#11015)</span></span>
- <span data-ttu-id="0c9c4-416">更新測試以正確描述測試動作。</span><span class="sxs-lookup"><span data-stu-id="0c9c4-416">Update tests to accurately describe test actions.</span></span> <span data-ttu-id="0c9c4-417">(#10928) (感謝 @romero126！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-417">(#10928) (Thanks @romero126!)</span></span>
- <span data-ttu-id="0c9c4-418">暫時略過不穩定的測試 TestAppDomainProcessExitEvenHandlerNotLeaking (#10827)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-418">Temporary skip the flaky test TestAppDomainProcessExitEvenHandlerNotLeaking (#10827)</span></span>
- <span data-ttu-id="0c9c4-419">讓事件處理常式流失測試呈現穩定狀態 (#10790)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-419">Make the event handler leaking test stable (#10790)</span></span>
- <span data-ttu-id="0c9c4-420">在 CI YAML 中同步處理大小寫 (#10767) (感謝 @RDIL！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-420">Sync capitalization in CI YAML (#10767) (Thanks @RDIL!)</span></span>
- <span data-ttu-id="0c9c4-421">新增用於事件處理常式流失修正的測試 (#10768)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-421">Add test for the event handler leaking fix (#10768)</span></span>
- <span data-ttu-id="0c9c4-422">新增 Get-ChildItem 測試 (#10507) (感謝 @iSazonov！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-422">Add Get-ChildItem test (#10507) (Thanks @iSazonov!)</span></span>
- <span data-ttu-id="0c9c4-423">針對要切換到參數的測試，取代模擬兩可的語言，以確保正確性 (#10666) (感謝 @romero126！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-423">Replace ambiguous language for tests from switch to parameter for accuracy (#10666) (Thanks @romero126!)</span></span>
- <span data-ttu-id="0c9c4-424">將實驗性檢查新增至 ForEach-Object -Parallel 測試 (#10354) (感謝 @KirkMunro！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-424">Add experimental check to ForEach-Object -Parallel tests (#10354) (Thanks @KirkMunro!)</span></span>
- <span data-ttu-id="0c9c4-425">更新 Alpine 驗證的測試 (#10428)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-425">Update tests for Alpine validation (#10428)</span></span>

### <a name="build-and-package-improvements"></a><span data-ttu-id="0c9c4-426">組建和套件的改善</span><span class="sxs-lookup"><span data-stu-id="0c9c4-426">Build and Package Improvements</span></span>

- <span data-ttu-id="0c9c4-427">修正協調套件組建的 Nuget 套件簽署 (#11316)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-427">Fix Nuget package signing for Coordinated Package build (#11316)</span></span>
- <span data-ttu-id="0c9c4-428">更新 PowerShell 資源庫和 NuGet 的相依性 (#11323)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-428">Update dependencies from PowerShell Gallery and NuGet (#11323)</span></span>
- <span data-ttu-id="0c9c4-429">將 Microsoft.ApplicationInsights 從 2.11.0 改成 2.12.0 (#11305)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-429">Bump Microsoft.ApplicationInsights from 2.11.0 to 2.12.0 (#11305)</span></span>
- <span data-ttu-id="0c9c4-430">將 Microsoft.CodeAnalysis.CSharp 從 3.3.1 改成 3.4.0 (#11265)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-430">Bump Microsoft.CodeAnalysis.CSharp from 3.3.1 to 3.4.0 (#11265)</span></span>
- <span data-ttu-id="0c9c4-431">更新 Debian 10 和 11 的套件 (#11236)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-431">Updates packages for Debian 10 and 11 (#11236)</span></span>
- <span data-ttu-id="0c9c4-432">只在 RC 之前啟用實驗性功能 (#11162)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-432">Only enable experimental features prior to RC (#11162)</span></span>
- <span data-ttu-id="0c9c4-433">更新 macOS 最小版本 (#11163)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-433">Update macOS minimum version (#11163)</span></span>
- <span data-ttu-id="0c9c4-434">將 NJsonSchema 從 10.0.27 改成 10.0.28 (#11170)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-434">Bump NJsonSchema from 10.0.27 to 10.0.28 (#11170)</span></span>
- <span data-ttu-id="0c9c4-435">正在針對 Preview.5 更新 README.md 中的連結和 metadata.json (#10854)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-435">Updating links in README.md and metadata.json for Preview.5 (#10854)</span></span>
- <span data-ttu-id="0c9c4-436">選取用於進行 PowerShell 所擁有之合規性測試的檔案 (#10837)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-436">Select the files for compliance tests which are owned by PowerShell (#10837)</span></span>
- <span data-ttu-id="0c9c4-437">允許建置 win7x86 msix 套件。</span><span class="sxs-lookup"><span data-stu-id="0c9c4-437">Allow win7x86 msix package to build.</span></span> <span data-ttu-id="0c9c4-438">(內部 10515)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-438">(Internal 10515)</span></span>
- <span data-ttu-id="0c9c4-439">允許將語意版本傳遞至 NormalizeVersion 函式 (#11087)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-439">Allow semantic versions to be passed to NormalizeVersion function (#11087)</span></span>
- <span data-ttu-id="0c9c4-440">將 .NET Core Framework 改成 3.1-preview.3 (#11079)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-440">Bump .NET core framework to 3.1-preview.3 (#11079)</span></span>
- <span data-ttu-id="0c9c4-441">在 /src/Modules 中，將 PSReadLine 從 2.0.0-beta5 改成 2.0.0-beta6 (#11078)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-441">Bump PSReadLine from 2.0.0-beta5 to 2.0.0-beta6 in /src/Modules (#11078)</span></span>
- <span data-ttu-id="0c9c4-442">將 Newtonsoft.Json 從 12.0.2 改成 12.0.3 (#11037) (#11038)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-442">Bump Newtonsoft.Json from 12.0.2 to 12.0.3 (#11037) (#11038)</span></span>
- <span data-ttu-id="0c9c4-443">新增 Debian 10、11 和 CentOS 8 套件 (#11028)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-443">Add Debian 10, 11 and CentOS 8 packages (#11028)</span></span>
- <span data-ttu-id="0c9c4-444">使用 ReleaseDate 欄位上傳 Build-Info Json 檔案 (#10986)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-444">Upload Build-Info Json file with the ReleaseDate field (#10986)</span></span>
- <span data-ttu-id="0c9c4-445">將 .NET Core Framework 改成 3.1-preview.2 (#10993)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-445">Bump .NET core framework to 3.1-preview.2 (#10993)</span></span>
- <span data-ttu-id="0c9c4-446">啟用 x86 MSIX 套件的組建 (#10934)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-446">Enable build of x86 MSIX package (#10934)</span></span>
- <span data-ttu-id="0c9c4-447">更新 build.psm1 中的 dotnet SDK 安裝指令碼 URL (#10927)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-447">Update the dotnet SDK install script URL in build.psm1 (#10927)</span></span>
- <span data-ttu-id="0c9c4-448">將 Markdig.Signed 從 0.17.1 改成 0.18.0 (#10887)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-448">Bump Markdig.Signed from 0.17.1 to 0.18.0 (#10887)</span></span>
- <span data-ttu-id="0c9c4-449">將 ThreadJob 從 2.0.1 改成 2.0.2 (#10886)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-449">Bump ThreadJob from 2.0.1 to 2.0.2 (#10886)</span></span>
- <span data-ttu-id="0c9c4-450">更新 AppX 資訊清單和封裝模組以符合 MS Store 需求 (#10878)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-450">Update AppX Manifest and Packaging module to conform to MS Store requirements (#10878)</span></span>
- <span data-ttu-id="0c9c4-451">將 PowerShell SDK 的套件參考更新為 preview.5 (內部 10295)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-451">Update package reference for PowerShell SDK to preview.5 (Internal 10295)</span></span>
- <span data-ttu-id="0c9c4-452">更新 ThirdPartyNotices.txt (#10834)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-452">Update ThirdPartyNotices.txt (#10834)</span></span>
- <span data-ttu-id="0c9c4-453">將 Microsoft.PowerShell.Native 改成 7.0.0-preview.3 (#10826)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-453">Bump Microsoft.PowerShell.Native to 7.0.0-preview.3 (#10826)</span></span>
- <span data-ttu-id="0c9c4-454">將 Microsoft.ApplicationInsights 從 2.10.0 改成 2.11.0 (#10608)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-454">Bump Microsoft.ApplicationInsights from 2.10.0 to 2.11.0 (#10608)</span></span>
- <span data-ttu-id="0c9c4-455">將 NJsonSchema 從 10.0.24 改成 10.0.27 (#10756)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-455">Bump NJsonSchema from 10.0.24 to 10.0.27 (#10756)</span></span>
- <span data-ttu-id="0c9c4-456">將 MacPorts 支援新增至建置系統 (#10736) (感謝 @Lucius-Q-User！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-456">Add MacPorts support to the build system (#10736) (Thanks @Lucius-Q-User!)</span></span>
- <span data-ttu-id="0c9c4-457">將 PackageManagement 從 1.4.4 改成 1.4.5 (#10728)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-457">Bump PackageManagement from 1.4.4 to 1.4.5 (#10728)</span></span>
- <span data-ttu-id="0c9c4-458">將 NJsonSchema 從 10.0.23 改成 10.0.24 (#10635)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-458">Bump NJsonSchema from 10.0.23 to 10.0.24 (#10635)</span></span>
- <span data-ttu-id="0c9c4-459">新增環境變數以區別 MSI 中的用戶端/伺服器遙測 (#10612)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-459">Add environment variable to differentiate client/server telemetry in MSI (#10612)</span></span>
- <span data-ttu-id="0c9c4-460">將 PSDesiredStateConfiguration 從 2.0.3 改成 2.0.4 (#10603)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-460">Bump PSDesiredStateConfiguration from 2.0.3 to 2.0.4 (#10603)</span></span>
- <span data-ttu-id="0c9c4-461">將 Microsoft.CodeAnalysis.CSharp 從 3.2.1 改成 3.3.1 (#10607)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-461">Bump Microsoft.CodeAnalysis.CSharp from 3.2.1 to 3.3.1 (#10607)</span></span>
- <span data-ttu-id="0c9c4-462">更新為 .Net Core 3.0 RTM (#10604) (感謝 @bergmeister！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-462">Update to .Net Core 3.0 RTM (#10604) (Thanks @bergmeister!)</span></span>
- <span data-ttu-id="0c9c4-463">更新 MSIX 封裝，使版本符合 Windows 市集需求 (#10588)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-463">Update MSIX packaging so the version to Windows Store requirements (#10588)</span></span>
- <span data-ttu-id="0c9c4-464">將 PowerShellGet 版本從 2.2 改成 2.2.1 (#10382)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-464">Bump PowerShellGet version from 2.2 to 2.2.1 (#10382)</span></span>
- <span data-ttu-id="0c9c4-465">將 PackageManagement 版本從 1.4.3 改成 1.4.4 (#10383)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-465">Bump PackageManagement version from 1.4.3 to 1.4.4 (#10383)</span></span>
- <span data-ttu-id="0c9c4-466">針對 7.0.0-preview.4 更新 README.md 和 metadata.json (內部 10011)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-466">Update README.md and metadata.json for 7.0.0-preview.4 (Internal 10011)</span></span>
- <span data-ttu-id="0c9c4-467">將 .Net Core 3.0 版從 Preview 9 升級為 RC1 (#10552) (感謝 @bergmeister！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-467">Upgrade .Net Core 3.0 version from Preview 9 to RC1 (#10552) (Thanks @bergmeister!)</span></span>
- <span data-ttu-id="0c9c4-468">修正 ExperimentalFeature 清單產生 (內部 9996)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-468">Fix ExperimentalFeature list generation (Internal 9996)</span></span>
- <span data-ttu-id="0c9c4-469">將 PSReadLine 版本從 2.0.0-beta4 改成 2.0.0-beta5 (#10536)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-469">Bump PSReadLine version from 2.0.0-beta4 to 2.0.0-beta5 (#10536)</span></span>
- <span data-ttu-id="0c9c4-470">修正發行組建指令碼以設定發行標籤</span><span class="sxs-lookup"><span data-stu-id="0c9c4-470">Fix release build script to set release tag</span></span>
- <span data-ttu-id="0c9c4-471">將 Microsoft.PowerShell.Native 的版本更新為 7.0.0-preview.2 (#10519)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-471">Update version of Microsoft.PowerShell.Native to 7.0.0-preview.2 (#10519)</span></span>
- <span data-ttu-id="0c9c4-472">升級為 Netcoreapp3.0 preview9 (#10484) (感謝 @bergmeister！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-472">Upgrade to Netcoreapp3.0 preview9 (#10484) (Thanks @bergmeister!)</span></span>
- <span data-ttu-id="0c9c4-473">確定每日協調組建，了解其為每日組建 (#10464)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-473">Make sure the daily coordinated build, knows it is a daily build (#10464)</span></span>
- <span data-ttu-id="0c9c4-474">更新合併的套件組建以發行每日組建 (#10449)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-474">Update the combined package build to release the daily builds (#10449)</span></span>
- <span data-ttu-id="0c9c4-475">移除 AppVeyor 參考 (#10445) (感謝 @RDIL！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-475">Remove appveyor reference (#10445) (Thanks @RDIL!)</span></span>
- <span data-ttu-id="0c9c4-476">將 NJsonSchema 版本從 10.0.22 改成 10.0.23 (#10421)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-476">Bump NJsonSchema version from 10.0.22 to 10.0.23 (#10421)</span></span>
- <span data-ttu-id="0c9c4-477">移除 linux-x64 組建資料夾的刪除功能，因為某些適用於 Alpine 的相依性需要該資料夾 (#10407)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-477">Remove the deletion of linux-x64 build folder because some dependencies for Alpine need it (#10407)</span></span>

### <a name="documentation-and-help-content"></a><span data-ttu-id="0c9c4-478">文件和說明內容</span><span class="sxs-lookup"><span data-stu-id="0c9c4-478">Documentation and Help Content</span></span>

- <span data-ttu-id="0c9c4-479">針對每個版本，將變更記錄重構成一個記錄 (#11165)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-479">Refactor change logs into one log per release (#11165)</span></span>
- <span data-ttu-id="0c9c4-480">修正適用於 PowerShell 7 線上說明文件的 FWLinks (#11071)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-480">Fix FWLinks for PowerShell 7 online help documents (#11071)</span></span>
- <span data-ttu-id="0c9c4-481">更新 CONTRIBUTING.md (#11096) (感謝 @mklement0！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-481">Update CONTRIBUTING.md (#11096) (Thanks @mklement0!)</span></span>
- <span data-ttu-id="0c9c4-482">修正 README.md 中的安裝文件連結 (#11083)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-482">Fix installation doc links in README.md (#11083)</span></span>
- <span data-ttu-id="0c9c4-483">將範例新增至 install-powershell.ps1 指令碼 (#11024) (感謝 @kilasuit！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-483">Adds examples to install-powershell.ps1 script (#11024) (Thanks @kilasuit!)</span></span>
- <span data-ttu-id="0c9c4-484">修正 CHANGELOG.md 中的 Select-String emphasis 和 Import-DscResource (#10890)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-484">Fix to Select-String emphasis and Import-DscResource in CHANGELOG.md (#10890)</span></span>
- <span data-ttu-id="0c9c4-485">從 powershell-beginners-guide.md 移除過時的連結 (#10926)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-485">Remove the stale link from powershell-beginners-guide.md (#10926)</span></span>
- <span data-ttu-id="0c9c4-486">合併穩定和維護變更記錄 (#10527)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-486">Merge stable and servicing change logs (#10527)</span></span>
- <span data-ttu-id="0c9c4-487">在組建文件中更新所使用的 .NET 版本 (#10775) (感謝 @Greg-Smulko！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-487">Update used .NET version in build docs (#10775) (Thanks @Greg-Smulko!)</span></span>
- <span data-ttu-id="0c9c4-488">在 powershell-beginners-guide.md 中將 MSDN 的連結取代為 docs.microsoft.com (#10778) (感謝 @iSazonov！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-488">Replace links from MSDN to docs.microsoft.com in powershell-beginners-guide.md (#10778) (Thanks @iSazonov!)</span></span>
- <span data-ttu-id="0c9c4-489">修正中斷的 DSC 概觀連結 (#10702)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-489">Fix broken DSC overview link (#10702)</span></span>
- <span data-ttu-id="0c9c4-490">更新 Support_Question.md，以連結至 Stack Overflow 作為另一個社群資源 (#10638) (感謝 @mklement0！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-490">Update Support_Question.md to link to Stack Overflow as another community resource (#10638) (Thanks @mklement0!)</span></span>
- <span data-ttu-id="0c9c4-491">將處理器架構新增至散發要求範本 (#10661)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-491">Add processor architecture to distribution request template (#10661)</span></span>
- <span data-ttu-id="0c9c4-492">將新的 PowerShell MoL 書籍新增至了解 PowerShell 文件中 (#10602)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-492">Add new PowerShell MoL book to learning PowerShell docs (#10602)</span></span>
- <span data-ttu-id="0c9c4-493">針對 v 6.1.6 和 v6.2.3 版本更新 README.md 和中繼資料 (#10523)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-493">Update README.md and metadata for v6.1.6 and v6.2.3 releases (#10523)</span></span>
- <span data-ttu-id="0c9c4-494">修正 README.md 中的打字錯誤 (#10465) (感謝 @vedhasp！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-494">Fix a typo in README.md (#10465) (Thanks @vedhasp!)</span></span>
- <span data-ttu-id="0c9c4-495">將 PSKoans 模組的參考新增至學習資源文件中 (#10369) (感謝 @vexx32！)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-495">Add a reference to PSKoans module to Learning Resources documentation (#10369) (Thanks @vexx32!)</span></span>
- <span data-ttu-id="0c9c4-496">針對 7.0.0-preview.3 更新 README.md 和 metadata.json (#10393)</span><span class="sxs-lookup"><span data-stu-id="0c9c4-496">Update README.md and metadata.json for 7.0.0-preview.3 (#10393)</span></span>
