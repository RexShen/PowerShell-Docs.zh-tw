# <a name="powershell-core-on-arm"></a><span data-ttu-id="18874-101">在 ARM 上使用 PowerShell Core</span><span class="sxs-lookup"><span data-stu-id="18874-101">PowerShell Core on ARM</span></span>
