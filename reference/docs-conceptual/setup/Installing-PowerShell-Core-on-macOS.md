# <a name="installing-powershell-core-on-macos"></a><span data-ttu-id="6174a-101">在 macOS 上安裝 PowerShell Core</span><span class="sxs-lookup"><span data-stu-id="6174a-101">Installing PowerShell Core on macOS</span></span>
