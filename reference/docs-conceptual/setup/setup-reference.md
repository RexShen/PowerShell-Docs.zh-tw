...
- [在 macOS 與 Linux 上安裝 PowerShell Core](Installing-PowerShell-Core-on-macOS-and-Linux.md)
...
- [安裝 Windows PowerShell SDK](Installing-the-Windows-PowerShell-SDK.md)
- [安裝參考](setup-reference.md)
