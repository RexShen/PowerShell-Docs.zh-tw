...
## <a name="cmdlets-use-standard-parameters"></a><span data-ttu-id="854b3-156">Cmdlet 使用標準參數</span><span class="sxs-lookup"><span data-stu-id="854b3-156">Cmdlets use standard parameters</span></span>
