...
請注意，**StatusData** 屬性是具有一些屬性的物件。 這是大部分報告資料的所在位置。 讓我們看看
最新報表之 **StatusData** 屬性的個別欄位：
...
除了其他屬性，這還會顯示最新設定呼叫的兩項資源，其中一項處於預期狀態，另一項處於非預期狀態。 您可以取得
僅限 **ResourcesNotInDesiredState** 屬性之更容易讀取的輸出：
