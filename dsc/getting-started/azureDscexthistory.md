...
- **新功能：**
  ...
  - 修正重新開機後，延伸模組停止處理設定的間歇性問題。 此問題原先會導致 DSC 延伸模組停留在 [轉換中] 狀態。
  - 同時新增其他小幅度修正與改善項目。
...
- **新功能：**
  ...
  - 很抱歉，若您已經安裝了 2.14 版且遇到上述兩個問題之一，就必須手動執行這些步驟。  在提升權限的 PowerShell 工作階段：
