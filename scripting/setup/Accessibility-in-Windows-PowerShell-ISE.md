...
-   若要將指令碼窗格移動到主控台窗格右方，請按 **CTRL\+2**，或者按一下工具列的**靠右顯示指令碼窗格**圖示，或在 **[檢視]** 功能表中，按一下 **[靠右顯示指令碼窗格]**。

-   若要將指令碼窗格最大化，請按 **CTRL\+3**，或者按一下工具列的**顯示最大化的指令碼窗格**圖示，或在 **[檢視]** 功能表中，按一下 **[顯示最大化的指令碼窗格]**。
