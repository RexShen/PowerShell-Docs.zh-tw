...
|動態模組|只存在於記憶體中的模組。 Import-PSSession Cmdlet 會建立動態模組。|
...
|[!INCLUDE[wps_2](../Token/wps_2_md.md)] 工作流程|工作流程是一系列經過程式設計、相互連結的步驟，能夠執行長期的工作，或是需要與多部裝置或受管理節點上的多個步驟協調進行。 [!INCLUDE[wps_2](../Token/wps_2_md.md)] 工作流程可讓 IT 專業人員和開發人員將連續的多重裝置管理活動或工作流程內的單一工作，編寫為工作流程。 [!INCLUDE[wps_2](../Token/wps_2_md.md)] 工作流程可讓您調整並執行 [!INCLUDE[wps_2](../Token/wps_2_md.md)] 指令碼和 XAML 檔案作為工作流程。|
