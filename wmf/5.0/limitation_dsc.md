...
<a name="breaking-change-certificates-used-to-encryptdecrypt-passwords-in-dsc-configurations-may-not-work-after-installing-wmf-50-rtm"></a>重大變更︰用來加密/解密 DSC 組態中密碼的憑證可能無法在安裝 WMF 5.0 RTM 之後執行
--------------------------------------------------------------------------------------------------------------------------------
