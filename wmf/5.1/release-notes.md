...
- **WMF 5.1 需要 .NET Framework 4.5**。 安裝會成功，但若未安裝 .NET 4.5，主要功能將會失敗。 您可在[安裝和設定 WMF 5.1](https://msdn.microsoft.com/en-us/powershell/wmf/5.1/install-configure) 主題中取得指示。 
