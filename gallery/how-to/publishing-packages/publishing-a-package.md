...
強烈建議您檢閱[發行指導分針](/powershell/gallery/concepts/publishing-guidelines) \(英文\)，以了解如何確保您發行的項目將更廣泛地獲得「PowerShell 資源庫」使用者接受。
...
強烈建議您檢閱[發行指導方針](/powershell/gallery/concepts/publishing-guidelines) \(英文\) 的 ＜項目中繼資料＞ (Item Metadata) 一節，以了解如何為您項目的使用者提供最佳資訊。
...
您必須使用 [Publish-Script](/powershell/module/PowerShellGet/publish-script) 或 [Publish-Module](/powershell/module/PowerShellGet/publish-module) 將項目發行至「PowerShell 資源庫」。
這些命令都需要
