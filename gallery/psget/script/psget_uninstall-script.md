...
---
# <a name="uninstall-script"></a><span data-ttu-id="8c4f8-103">Uninstall-Script</span><span class="sxs-lookup"><span data-stu-id="8c4f8-103">Uninstall-Script</span></span>

<span data-ttu-id="8c4f8-104">解除安裝使用 PowerShellGet 所安裝的指令檔。</span><span class="sxs-lookup"><span data-stu-id="8c4f8-104">Uninstalls a script file which was installed using PowerShellGet.</span></span>

## <a name="description"></a><span data-ttu-id="8c4f8-105">描述</span><span class="sxs-lookup"><span data-stu-id="8c4f8-105">Description</span></span>

<span data-ttu-id="8c4f8-106">Uninstall-Script Cmdlet 會解除安裝已從線上存放庫安裝的指定指令檔。</span><span class="sxs-lookup"><span data-stu-id="8c4f8-106">The Uninstall-Script cmdlet uninstalls the specified script files which were installed from the online repository.</span></span>

## <a name="cmdlet-syntax"></a><span data-ttu-id="8c4f8-107">Cmdlet 語法</span><span class="sxs-lookup"><span data-stu-id="8c4f8-107">Cmdlet syntax</span></span>

```powershell
Get-Command -Name Uninstall-Script -Module PowerShellGet -Syntax
```
## <a name="cmdlet-online-help-reference"></a><span data-ttu-id="8c4f8-108">Cmdlet 線上說明參考資料</span><span class="sxs-lookup"><span data-stu-id="8c4f8-108">Cmdlet online help reference</span></span>

[<span data-ttu-id="8c4f8-109">Uninstall-Script</span><span class="sxs-lookup"><span data-stu-id="8c4f8-109">Uninstall-Script</span></span>](http://go.microsoft.com/fwlink/?LinkId=619789)

## <a name="example-commands"></a><span data-ttu-id="8c4f8-110">範例命令</span><span class="sxs-lookup"><span data-stu-id="8c4f8-110">Example commands</span></span>
