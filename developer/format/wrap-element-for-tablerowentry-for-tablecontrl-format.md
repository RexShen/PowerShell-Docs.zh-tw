...
---
# <a name="wrap-element-for-tablerowentry-for-tablecontrl--format"></a>TableControl 之 TableRowEntry 的包裝元素 (格式)
...
|元素|描述|
|-------------|-----------------|
|[TablControl （格式） 的 TabbleRowEntries TableRowEntry 項目](./tablerowentry-element-for-tablerowentroes-for-tablecontrol-format.md)|定義會顯示在資料表資料列的資料。|
