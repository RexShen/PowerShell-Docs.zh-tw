...
下列程式碼顯示中所述的 Windows PowerShell 巡覽提供者的實作[建立 Windows PowerShell 巡覽提供者](./creating-a-windows-powershell-navigation-provider.md)。 此提供者支援遞迴命令，巢狀的容器，以便可以瀏覽資料存放區的相對路徑。
