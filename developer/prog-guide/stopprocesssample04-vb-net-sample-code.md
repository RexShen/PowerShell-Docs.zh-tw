...
ms.locfileid: "62081099"
---
# <a name="stopprocesssample04-vbnet-sample-code"></a><span data-ttu-id="3c213-102">StopProcessSample04 (VB.NET) 範例程式碼</span><span class="sxs-lookup"><span data-stu-id="3c213-102">StopProcessSample04 (VB.NET) Sample Code</span></span>

<span data-ttu-id="3c213-103">以下是 StopProc04 範例 cmdlet 的完整 VB.NET 範例程式碼。</span><span class="sxs-lookup"><span data-stu-id="3c213-103">Here is the complete VB.NET sample code for the StopProc04 sample cmdlet.</span></span> <span data-ttu-id="3c213-104">這是程式碼`Stop-Process`中所述的 cmdlet[新增至 Cmdlet 的參數集](../cmdlet/adding-parameter-sets-to-a-cmdlet.md)。</span><span class="sxs-lookup"><span data-stu-id="3c213-104">This is the code for the `Stop-Process` cmdlet described in [Adding Parameter Sets to a Cmdlet](../cmdlet/adding-parameter-sets-to-a-cmdlet.md).</span></span> <span data-ttu-id="3c213-105">`Stop-Process`指令程式設計來停止處理程序會擷取使用 Get-proc cmdlet (中所述[建立您的第一個 Cmdlet](../cmdlet/creating-a-cmdlet-without-parameters.md))。</span><span class="sxs-lookup"><span data-stu-id="3c213-105">The `Stop-Process` cmdlet is designed to stop processes that are retrieved using the Get-Proc cmdlet (described in [Creating Your First Cmdlet](../cmdlet/creating-a-cmdlet-without-parameters.md)).</span></span>

> [!NOTE]
> <span data-ttu-id="3c213-106">您可以下載的 Microsoft Windows 軟體開發套件的 Windows Vista 和.NET Framework 3.0 執行階段元件使用此停止程序 cmdlet VB.NET (stopprocesssample04.vb) 的原始程式檔。</span><span class="sxs-lookup"><span data-stu-id="3c213-106">You can download the VB.NET (stopprocesssample04.vb) source file for this Stop-Proc cmdlet using the Microsoft Windows Software Development Kit for Windows Vista and .NET Framework 3.0 Runtime Components.</span></span> <span data-ttu-id="3c213-107">如需下載指示，請參閱[如何安裝 Windows PowerShell 並下載 Windows PowerShell SDK](/powershell/developer/installing-the-windows-powershell-sdk)。</span><span class="sxs-lookup"><span data-stu-id="3c213-107">For download instructions, see [How to Install Windows PowerShell and Download the Windows PowerShell SDK](/powershell/developer/installing-the-windows-powershell-sdk).</span></span>
>
> <span data-ttu-id="3c213-108">已下載的原始程式檔位於 **\<PowerShell 範例 >** 目錄。</span><span class="sxs-lookup"><span data-stu-id="3c213-108">The downloaded source files are available in the **\<PowerShell Samples>** directory.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="3c213-109">另請參閱</span><span class="sxs-lookup"><span data-stu-id="3c213-109">See Also</span></span>

[<span data-ttu-id="3c213-110">Windows PowerShell 程式設計人員指南</span><span class="sxs-lookup"><span data-stu-id="3c213-110">Windows PowerShell Programmer's Guide</span></span>](./windows-powershell-programmer-s-guide.md)

[<span data-ttu-id="3c213-111">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="3c213-111">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)