...
ms.locfileid: "58056408"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="e4c2c-102">GetProc05 (VB.NET) 範例程式碼</span><span class="sxs-lookup"><span data-stu-id="e4c2c-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="e4c2c-103">以下是 GetProc05 範例 cmdlet 的完整 VB.NET 程式碼。</span><span class="sxs-lookup"><span data-stu-id="e4c2c-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="e4c2c-104">另請參閱</span><span class="sxs-lookup"><span data-stu-id="e4c2c-104">See Also</span></span>

[<span data-ttu-id="e4c2c-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="e4c2c-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)