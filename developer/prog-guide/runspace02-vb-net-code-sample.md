...
以下是 Runspace02 範例的 VB.NET 原始程式碼。 這個範例會使用[System.Management.Automation.Runspaceinvoke](/dotnet/api/System.Management.Automation.RunspaceInvoke)類別，以執行`Get-Process`cmdlet 以同步方式。 Windows Form 和資料繫結，然後使用 DataGridView 控制項中顯示結果。
