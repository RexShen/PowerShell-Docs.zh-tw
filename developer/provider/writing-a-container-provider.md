...
[System.Management.Automation.Provider.Containercmdletprovider](/dotnet/api/System.Management.Automation.Provider.ContainerCmdletProvider)類別會實作支援容器，以及建立、 複製和移除項目方法。 如需這些方法的完整清單，請參閱 < [ContainerCmdletProvider 方法](http://msdn.microsoft.com/library/system.management.automation.provider.containercmdletprovider_methods\(v=vs.85\).aspx)。
