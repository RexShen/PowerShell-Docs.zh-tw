...
此範例示範如何建構遠端 runspace 集區，以及如何使用此集區同時執行多個命令。
...
- 執行[Get-process](/powershell/module/Microsoft.PowerShell.Management/Get-Process)並[Get-service](/powershell/module/microsoft.powershell.management/get-service) cmdlet 同時藉由使用遠端 runspace 集區。

- 正在關閉遠端 runspace 集區，以釋出的遠端連線。
