...
## <a name="registering-the-job-with-the-task-scheduler"></a><span data-ttu-id="a08db-129">向工作排程器作業</span><span class="sxs-lookup"><span data-stu-id="a08db-129">Registering the Job with the Task Scheduler</span></span>
