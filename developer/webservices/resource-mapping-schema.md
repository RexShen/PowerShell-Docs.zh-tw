...
---
# <a name="resource-mapping-schema"></a>資源對應結構描述

Management OData IIS 擴充功能會使用 XML 檔案來定義資源對應。 下列 XSD 會定義用於這些檔案的結構描述。

## <a name="resource-mapping-file-xsd"></a>資源對應檔案 XSD

下列 XSD 定義 Management OData IIS 擴充功能資源對應檔案的結構描述。
