...
ms.locfileid: "62080555"
---
# <a name="resource-mapping-schema"></a><span data-ttu-id="9762e-102">資源對應結構描述</span><span class="sxs-lookup"><span data-stu-id="9762e-102">Resource Mapping Schema</span></span>

<span data-ttu-id="9762e-103">Management OData IIS 擴充功能會使用 XML 檔案來定義資源對應。</span><span class="sxs-lookup"><span data-stu-id="9762e-103">Management OData IIS Extension uses XML files to define resource mapping.</span></span> <span data-ttu-id="9762e-104">下列 XSD 會定義用於這些檔案的結構描述。</span><span class="sxs-lookup"><span data-stu-id="9762e-104">The following XSD defines the schema used for these files.</span></span>

## <a name="resource-mapping-file-xsd"></a><span data-ttu-id="9762e-105">資源對應檔案 XSD</span><span class="sxs-lookup"><span data-stu-id="9762e-105">Resource Mapping File XSD</span></span>

<span data-ttu-id="9762e-106">下列 XSD 定義 Management OData IIS 擴充功能資源對應檔案的結構描述。</span><span class="sxs-lookup"><span data-stu-id="9762e-106">The following XSD defines the schema for Management OData IIS Extension resource mapping files.</span></span>
