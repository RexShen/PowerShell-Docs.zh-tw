...
此範例示範如何撰寫的 cmdlet 的參數具有別名和其參數支援萬用字元。 此 cmdlet 會類似於`Stop-Process`Windows PowerShell 2.0 所提供的 cmdlet。

### <a name="how-to-build-the-sample-by-using-visual-studio"></a>如何使用 Visual Studio 建置範例。

1. 安裝 Windows PowerShell 2.0 sdk，瀏覽至 StopProcessSample03 資料夾。 預設位置是 C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample03。
