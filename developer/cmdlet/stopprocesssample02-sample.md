...
3. <span data-ttu-id="6e5e2-111">在 **建置**功能表上，選取**建置方案**。</span><span class="sxs-lookup"><span data-stu-id="6e5e2-111">In the **Build** menu, select **Build Solution**.</span></span>
